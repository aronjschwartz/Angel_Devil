...
# used as array indices so they must be be contiguous starting from 0
# TODO: rename x_MOTOR -> x_SERVO
# TODO: swap ROT_MOTOR and TIP_MOTOR values so WAIST_MOTOR = ROT_MOTOR = 0
TIP_MOTOR = 0
MID_MOTOR = 1
ROT_MOTOR = 2
WAIST_MOTOR = 0
...
# TODO: rename x_MOTOR_x to x_SERVO_x
...
# usage: LEG_PWM_CHANNEL[leg# 0-7][servo# 0-2]
...
# DO NOT CHANGE!!!
# TODO: rename LEG_PWM_CHANNEL -> PWM_CHANNEL_ARRAY
LEG_PWM_CHANNEL = [[None for i in range(3)] for j in range(9)]
LEG_PWM_CHANNEL[LEG_0][TIP_MOTOR] = CHANNEL_LEG0_TIP
LEG_PWM_CHANNEL[LEG_0][MID_MOTOR] = CHANNEL_LEG0_MID
LEG_PWM_CHANNEL[LEG_0][ROT_MOTOR] = CHANNEL_LEG0_ROT
LEG_PWM_CHANNEL[LEG_1][TIP_MOTOR] = CHANNEL_LEG1_TIP
LEG_PWM_CHANNEL[LEG_1][MID_MOTOR] = CHANNEL_LEG1_MID
LEG_PWM_CHANNEL[LEG_1][ROT_MOTOR] = CHANNEL_LEG1_ROT
LEG_PWM_CHANNEL[LEG_2][TIP_MOTOR] = CHANNEL_LEG2_TIP
LEG_PWM_CHANNEL[LEG_2][MID_MOTOR] = CHANNEL_LEG2_MID
LEG_PWM_CHANNEL[LEG_2][ROT_MOTOR] = CHANNEL_LEG2_ROT
LEG_PWM_CHANNEL[ARM_L][TIP_MOTOR] = CHANNEL_ARML_TIP
LEG_PWM_CHANNEL[ARM_L][MID_MOTOR] = CHANNEL_ARML_MID
LEG_PWM_CHANNEL[ARM_L][ROT_MOTOR] = CHANNEL_ARML_ROT
LEG_PWM_CHANNEL[WAIST][TIP_MOTOR] = CHANNEL_WAIST_ROT # waist gets all 3 entries on this row, just in case
LEG_PWM_CHANNEL[WAIST][MID_MOTOR] = CHANNEL_WAIST_ROT # waist gets all 3 entries on this row, just in case
LEG_PWM_CHANNEL[WAIST][ROT_MOTOR] = CHANNEL_WAIST_ROT # waist gets all 3 entries on this row, just in case
LEG_PWM_CHANNEL[LEG_3][TIP_MOTOR] = CHANNEL_LEG3_TIP
LEG_PWM_CHANNEL[LEG_3][MID_MOTOR] = CHANNEL_LEG3_MID
LEG_PWM_CHANNEL[LEG_3][ROT_MOTOR] = CHANNEL_LEG3_ROT
LEG_PWM_CHANNEL[LEG_4][TIP_MOTOR] = CHANNEL_LEG4_TIP
LEG_PWM_CHANNEL[LEG_4][MID_MOTOR] = CHANNEL_LEG4_MID
LEG_PWM_CHANNEL[LEG_4][ROT_MOTOR] = CHANNEL_LEG4_ROT
LEG_PWM_CHANNEL[LEG_5][TIP_MOTOR] = CHANNEL_LEG5_TIP
LEG_PWM_CHANNEL[LEG_5][MID_MOTOR] = CHANNEL_LEG5_MID
LEG_PWM_CHANNEL[LEG_5][ROT_MOTOR] = CHANNEL_LEG5_ROT
LEG_PWM_CHANNEL[ARM_R][TIP_MOTOR] = CHANNEL_ARMR_TIP
LEG_PWM_CHANNEL[ARM_R][MID_MOTOR] = CHANNEL_ARMR_MID
LEG_PWM_CHANNEL[ARM_R][ROT_MOTOR] = CHANNEL_ARMR_ROT
