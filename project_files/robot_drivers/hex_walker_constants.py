...
# example: LEG_PWM_CHANNEL[LEG_0][MID_SERVO]
# example: LEG_PWM_CHANNEL[LEG_RF] returns a list
# example: LEG_PWM_CHANNEL[WAIST][WAIST_SERVO]
# LEG_PWM_CHANNEL = [
...
LEG_PWM_CHANNEL = [[-1 for i in range(3)] for j in range(9)]
LEG_PWM_CHANNEL[LEG_0][TIP_SERVO] = CHANNEL_LEG0_TIP
LEG_PWM_CHANNEL[LEG_0][MID_SERVO] = CHANNEL_LEG0_MID
LEG_PWM_CHANNEL[LEG_0][ROT_SERVO] = CHANNEL_LEG0_ROT
LEG_PWM_CHANNEL[LEG_1][TIP_SERVO] = CHANNEL_LEG1_TIP
LEG_PWM_CHANNEL[LEG_1][MID_SERVO] = CHANNEL_LEG1_MID
LEG_PWM_CHANNEL[LEG_1][ROT_SERVO] = CHANNEL_LEG1_ROT
LEG_PWM_CHANNEL[LEG_2][TIP_SERVO] = CHANNEL_LEG2_TIP
LEG_PWM_CHANNEL[LEG_2][MID_SERVO] = CHANNEL_LEG2_MID
LEG_PWM_CHANNEL[LEG_2][ROT_SERVO] = CHANNEL_LEG2_ROT
LEG_PWM_CHANNEL[ARM_L][TIP_SERVO] = CHANNEL_ARML_TIP
LEG_PWM_CHANNEL[ARM_L][MID_SERVO] = CHANNEL_ARML_MID
LEG_PWM_CHANNEL[ARM_L][ROT_SERVO] = CHANNEL_ARML_ROT
LEG_PWM_CHANNEL[WAIST][TIP_SERVO] = CHANNEL_WAIST_ROT # waist gets all 3 entries on this row, just in case
LEG_PWM_CHANNEL[WAIST][MID_SERVO] = CHANNEL_WAIST_ROT # waist gets all 3 entries on this row, just in case
LEG_PWM_CHANNEL[WAIST][ROT_SERVO] = CHANNEL_WAIST_ROT # waist gets all 3 entries on this row, just in case
LEG_PWM_CHANNEL[LEG_3][TIP_SERVO] = CHANNEL_LEG3_TIP
LEG_PWM_CHANNEL[LEG_3][MID_SERVO] = CHANNEL_LEG3_MID
LEG_PWM_CHANNEL[LEG_3][ROT_SERVO] = CHANNEL_LEG3_ROT
LEG_PWM_CHANNEL[LEG_4][TIP_SERVO] = CHANNEL_LEG4_TIP
LEG_PWM_CHANNEL[LEG_4][MID_SERVO] = CHANNEL_LEG4_MID
LEG_PWM_CHANNEL[LEG_4][ROT_SERVO] = CHANNEL_LEG4_ROT
LEG_PWM_CHANNEL[LEG_5][TIP_SERVO] = CHANNEL_LEG5_TIP
LEG_PWM_CHANNEL[LEG_5][MID_SERVO] = CHANNEL_LEG5_MID
LEG_PWM_CHANNEL[LEG_5][ROT_SERVO] = CHANNEL_LEG5_ROT
LEG_PWM_CHANNEL[ARM_R][TIP_SERVO] = CHANNEL_ARMR_TIP
LEG_PWM_CHANNEL[ARM_R][MID_SERVO] = CHANNEL_ARMR_MID
LEG_PWM_CHANNEL[ARM_R][ROT_SERVO] = CHANNEL_ARMR_ROT
