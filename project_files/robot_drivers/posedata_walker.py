...
HEX_WALKER_POSITIONS = {
	...
	# 1
	NORMAL_NEUTRAL:
		Hex_Walker_Position(LEG_NORMAL_MOVEMENT_TABLE["NEUTRAL"],
	...
	# 3
	NORMAL_TRI_RIGHT_BACK_LEFT_UP_FORWARD:
		Hex_Walker_Position(LEG_NORMAL_MOVEMENT_TABLE["CORN_IN"],
	...
	# 5
	NORMAL_TRI_RIGHT_UP_BACK_LEFT_FORWARD:
		Hex_Walker_Position(LEG_NORMAL_MOVEMENT_TABLE["CORN_UP_IN"],
							LEG_NORMAL_MOVEMENT_TABLE["SIDE_LEFT"],
							LEG_NORMAL_MOVEMENT_TABLE["CORN_UP_OUT"],
							LEG_NORMAL_MOVEMENT_TABLE["CORN_IN"],
							LEG_NORMAL_MOVEMENT_TABLE["SIDE_UP_LEFT"],
	...
	# 6
	NORMAL_TRI_RIGHT_UP_NEUTRAL_LEFT_NEUTRAL:
		Hex_Walker_Position(LEG_NORMAL_MOVEMENT_TABLE["UP_NEUTRAL"],
							LEG_NORMAL_MOVEMENT_TABLE["NEUTRAL"],
							LEG_NORMAL_MOVEMENT_TABLE["UP_NEUTRAL"],
							LEG_NORMAL_MOVEMENT_TABLE["NEUTRAL"],
							LEG_NORMAL_MOVEMENT_TABLE["UP_NEUTRAL"],
	...
	# 7
	NORMAL_TRI_RIGHT_UP_FORWARD_LEFT_BACK:
		Hex_Walker_Position(LEG_NORMAL_MOVEMENT_TABLE["CORN_UP_OUT"],
	...
	# 8
	NORMAL_TRI_RIGHT_FORWARD_LEFT_BACK:
		Hex_Walker_Position(LEG_NORMAL_MOVEMENT_TABLE["CORN_OUT"],
							LEG_NORMAL_MOVEMENT_TABLE["SIDE_RIGHT"],
							LEG_NORMAL_MOVEMENT_TABLE["CORN_IN"],
							LEG_NORMAL_MOVEMENT_TABLE["CORN_OUT"],
							LEG_NORMAL_MOVEMENT_TABLE["SIDE_RIGHT"],
	...
	# 10
	NORMAL_TRI_RIGHT_RIGHT_LEFT_UP_LEFT:
		Hex_Walker_Position(LEG_NORMAL_ROTATION_TABLE["RIGHT"],
	...
	# 12
	NORMAL_TRI_RIGHT_UP_RIGHT_LEFT_LEFT:
		Hex_Walker_Position(LEG_NORMAL_ROTATION_TABLE["UP_RIGHT"],
							LEG_NORMAL_ROTATION_TABLE["LEFT"],
	...
	# 13
	NORMAL_TRI_RIGHT_UP_LEFT_LEFT_RIGHT:
		Hex_Walker_Position(LEG_NORMAL_ROTATION_TABLE["UP_LEFT"],
							LEG_NORMAL_ROTATION_TABLE["RIGHT"],
							LEG_NORMAL_ROTATION_TABLE["UP_LEFT"],
							LEG_NORMAL_ROTATION_TABLE["RIGHT"],
							LEG_NORMAL_ROTATION_TABLE["UP_LEFT"],
	...
	# 14
	NORMAL_TRI_RIGHT_LEFT_LEFT_RIGHT:
		Hex_Walker_Position(LEG_NORMAL_ROTATION_TABLE["LEFT"],
							LEG_NORMAL_ROTATION_TABLE["RIGHT"],
							LEG_NORMAL_ROTATION_TABLE["LEFT"],
							LEG_NORMAL_ROTATION_TABLE["RIGHT"],
							LEG_NORMAL_ROTATION_TABLE["LEFT"],
	...
	# 16
	CROUCH_NEUTRAL:
		Hex_Walker_Position(LEG_CROUCH_MOVEMENT_TABLE["NEUTRAL"],
	...
	CROUCH_TRI_RIGHT_BACK_LEFT_UP_FORWARD:
		Hex_Walker_Position(LEG_CROUCH_MOVEMENT_TABLE["NEUTRAL"],
							...
							LEG_CROUCH_MOVEMENT_TABLE["CORN_OUT_RIGHT"],
							LEG_CROUCH_MOVEMENT_TABLE["UP_NEUTRAL"],
							LEG_CROUCH_MOVEMENT_TABLE["NEUTRAL"],
							LEG_CROUCH_MOVEMENT_TABLE["CORN_UP_OUT_RIGHT"],
							[CROUCH_TRI_RIGHT_BACK_LEFT_UP_FORWARD,
							 CROUCH_TRI_RIGHT_NEUTRAL_LEFT_UP_NEUTRAL,
							 CROUCH_TRI_RIGHT_FORWARD_LEFT_UP_BACK,
	...
	# 20
	CROUCH_TRI_RIGHT_UP_BACK_LEFT_FORWARD:
		Hex_Walker_Position(LEG_CROUCH_MOVEMENT_TABLE["UP_NEUTRAL"],
							LEG_CROUCH_MOVEMENT_TABLE["SIDE_LEFT"],
							LEG_CROUCH_MOVEMENT_TABLE["CORN_UP_OUT_RIGHT"],
							LEG_CROUCH_MOVEMENT_TABLE["NEUTRAL"],
							LEG_CROUCH_MOVEMENT_TABLE["UP_NEUTRAL"],
	...
	# 22
	CROUCH_TRI_RIGHT_UP_FORWARD_LEFT_BACK:
		Hex_Walker_Position(LEG_CROUCH_MOVEMENT_TABLE["CORN_UP_OUT_LEFT"],
							LEG_CROUCH_MOVEMENT_TABLE["NEUTRAL"],
							LEG_CROUCH_MOVEMENT_TABLE["UP_NEUTRAL"],
							LEG_CROUCH_MOVEMENT_TABLE["CORN_OUT_LEFT"],
	...
	# 23
	CROUCH_TRI_RIGHT_FORWARD_LEFT_BACK:
		Hex_Walker_Position(LEG_CROUCH_MOVEMENT_TABLE["CORN_OUT_LEFT"],
							LEG_CROUCH_MOVEMENT_TABLE["NEUTRAL"],
							LEG_CROUCH_MOVEMENT_TABLE["NEUTRAL"],
							LEG_CROUCH_MOVEMENT_TABLE["CORN_OUT_LEFT"],
	...
	CROUCH_TRI_RIGHT_FORWARD_LEFT_UP_BACK:
		Hex_Walker_Position(LEG_CROUCH_MOVEMENT_TABLE["CORN_OUT_LEFT"],
							LEG_CROUCH_MOVEMENT_TABLE["UP_NEUTRAL"],
							LEG_CROUCH_MOVEMENT_TABLE["NEUTRAL"],
							LEG_CROUCH_MOVEMENT_TABLE["CORN_UP_OUT_LEFT"],
							LEG_CROUCH_MOVEMENT_TABLE["SIDE_RIGHT"],
							LEG_CROUCH_MOVEMENT_TABLE["UP_NEUTRAL"],
							[CROUCH_TRI_RIGHT_FORWARD_LEFT_UP_BACK,
							 CROUCH_TRI_RIGHT_NEUTRAL_LEFT_UP_NEUTRAL,
	...
	# 25
	CROUCH_TRI_RIGHT_RIGHT_LEFT_UP_LEFT:
		Hex_Walker_Position(LEG_CROUCH_ROTATION_TABLE["RIGHT"],
	...
	# 27
	CROUCH_TRI_RIGHT_UP_RIGHT_LEFT_LEFT:
		Hex_Walker_Position(LEG_CROUCH_ROTATION_TABLE["UP_RIGHT"],
							LEG_CROUCH_ROTATION_TABLE["LEFT"],
	...
	# 28
	CROUCH_TRI_RIGHT_UP_LEFT_LEFT_RIGHT:
		Hex_Walker_Position(LEG_CROUCH_ROTATION_TABLE["UP_LEFT"],
							LEG_CROUCH_ROTATION_TABLE["RIGHT"],
							LEG_CROUCH_ROTATION_TABLE["UP_LEFT"],
							LEG_CROUCH_ROTATION_TABLE["RIGHT"],
							LEG_CROUCH_ROTATION_TABLE["UP_LEFT"],
	...
	# 29
	CROUCH_TRI_RIGHT_LEFT_LEFT_RIGHT:
		Hex_Walker_Position(LEG_CROUCH_ROTATION_TABLE["LEFT"],
							LEG_CROUCH_ROTATION_TABLE["RIGHT"],
							LEG_CROUCH_ROTATION_TABLE["LEFT"],
							LEG_CROUCH_ROTATION_TABLE["RIGHT"],
							LEG_CROUCH_ROTATION_TABLE["LEFT"],
	...
	# 31
	TALL_NEUTRAL:
		Hex_Walker_Position(LEG_TALL_MOVEMENT_TABLE["NEUTRAL"],
	...
	TALL_TRI_RIGHT_BACK_LEFT_UP_FORWARD:
		Hex_Walker_Position(LEG_TALL_MOVEMENT_TABLE["NEUTRAL"],
							...
							LEG_TALL_MOVEMENT_TABLE["CORN_OUT_RIGHT"],
							LEG_TALL_MOVEMENT_TABLE["UP_NEUTRAL"],
							LEG_TALL_MOVEMENT_TABLE["NEUTRAL"],
							LEG_TALL_MOVEMENT_TABLE["CORN_UP_OUT_RIGHT"],
							[TALL_TRI_RIGHT_BACK_LEFT_UP_FORWARD,
							 TALL_TRI_RIGHT_NEUTRAL_LEFT_UP_NEUTRAL,
							 TALL_TRI_RIGHT_FORWARD_LEFT_UP_BACK,
	...
	# 35
	TALL_TRI_RIGHT_UP_BACK_LEFT_FORWARD:
		Hex_Walker_Position(LEG_TALL_MOVEMENT_TABLE["UP_NEUTRAL"],
							LEG_TALL_MOVEMENT_TABLE["SIDE_LEFT"],
							LEG_TALL_MOVEMENT_TABLE["CORN_UP_OUT_RIGHT"],
							LEG_TALL_MOVEMENT_TABLE["NEUTRAL"],
							LEG_TALL_MOVEMENT_TABLE["UP_NEUTRAL"],
	...
	# 37
	TALL_TRI_RIGHT_UP_FORWARD_LEFT_BACK:
		Hex_Walker_Position(LEG_TALL_MOVEMENT_TABLE["CORN_UP_OUT_LEFT"],
							LEG_TALL_MOVEMENT_TABLE["NEUTRAL"],
							LEG_TALL_MOVEMENT_TABLE["UP_NEUTRAL"],
							LEG_TALL_MOVEMENT_TABLE["CORN_OUT_LEFT"],
	...
	# 38
	TALL_TRI_RIGHT_FORWARD_LEFT_BACK:
		Hex_Walker_Position(LEG_TALL_MOVEMENT_TABLE["CORN_OUT_LEFT"],
							LEG_TALL_MOVEMENT_TABLE["NEUTRAL"],
							LEG_TALL_MOVEMENT_TABLE["NEUTRAL"],
							LEG_TALL_MOVEMENT_TABLE["CORN_OUT_LEFT"],
	...
	TALL_TRI_RIGHT_FORWARD_LEFT_UP_BACK:
		Hex_Walker_Position(LEG_TALL_MOVEMENT_TABLE["CORN_OUT_LEFT"],
							LEG_TALL_MOVEMENT_TABLE["UP_NEUTRAL"],
							LEG_TALL_MOVEMENT_TABLE["NEUTRAL"],
							LEG_TALL_MOVEMENT_TABLE["CORN_UP_OUT_LEFT"],
							LEG_TALL_MOVEMENT_TABLE["SIDE_RIGHT"],
							LEG_TALL_MOVEMENT_TABLE["UP_NEUTRAL"],
							[TALL_TRI_RIGHT_FORWARD_LEFT_UP_BACK,
							 TALL_TRI_RIGHT_NEUTRAL_LEFT_UP_NEUTRAL,
	...
	# 40
	TALL_TRI_RIGHT_RIGHT_LEFT_UP_LEFT:
		Hex_Walker_Position(LEG_TALL_ROTATION_TABLE["RIGHT"],
	...
	# 42
	TALL_TRI_RIGHT_UP_RIGHT_LEFT_LEFT:
		Hex_Walker_Position(LEG_TALL_ROTATION_TABLE["UP_RIGHT"],
							LEG_TALL_ROTATION_TABLE["LEFT"],
	...
	# 43
	TALL_TRI_RIGHT_UP_LEFT_LEFT_RIGHT:
		Hex_Walker_Position(LEG_TALL_ROTATION_TABLE["UP_LEFT"],
							LEG_TALL_ROTATION_TABLE["RIGHT"],
							LEG_TALL_ROTATION_TABLE["UP_LEFT"],
							LEG_TALL_ROTATION_TABLE["RIGHT"],
							LEG_TALL_ROTATION_TABLE["UP_LEFT"],
	...
	# 44
	TALL_TRI_RIGHT_LEFT_LEFT_RIGHT:
		Hex_Walker_Position(LEG_TALL_ROTATION_TABLE["LEFT"],
							LEG_TALL_ROTATION_TABLE["RIGHT"],
							LEG_TALL_ROTATION_TABLE["LEFT"],
							LEG_TALL_ROTATION_TABLE["RIGHT"],
							LEG_TALL_ROTATION_TABLE["LEFT"],
	...
	# 46
	TALL_TRI_FRONT_CENTER_UP_OUT_BACK_NEUTRAL:
		Hex_Walker_Position(LEG_TALL_SIDE_MOVEMENT_TABLE["CENTER_UP_OUT"],
	...
	# 47
	TALL_TRI_FRONT_CENTER_OUT_BACK_UP_NEUTRAL:
		Hex_Walker_Position(LEG_TALL_SIDE_MOVEMENT_TABLE["CENTER_OUT"],
	...
	# 48
	TALL_TRI_FRONT_BACKWARDS_BACK_UP_NEUTRAL:
		Hex_Walker_Position(LEG_TALL_SIDE_MOVEMENT_TABLE["NEUTRAL"],
							LEG_TALL_SIDE_MOVEMENT_TABLE["UP_NEUTRAL"],
	...
	# 50
	TALL_TRI_FRONT_UP_NEUTRAL_BACK_NEUTRAL:
		Hex_Walker_Position(LEG_TALL_SIDE_MOVEMENT_TABLE["UP_NEUTRAL"],
							LEG_TALL_SIDE_MOVEMENT_TABLE["NEUTRAL"],
							LEG_TALL_SIDE_MOVEMENT_TABLE["UP_NEUTRAL"],
							LEG_TALL_SIDE_MOVEMENT_TABLE["NEUTRAL"],
							LEG_TALL_SIDE_MOVEMENT_TABLE["UP_NEUTRAL"],
	...
	# 54
	TALL_TRI_BOUNCE_DOWN:
		Hex_Walker_Position(LEG_MISC_TABLE["BOUNCE"],
	...
	# 55
	TALL_TRI_FINE_RIGHT_RIGHT_LEFT_UP_LEFT:
		Hex_Walker_Position(LEG_TALL_FINE_ROTATION_TABLE["RIGHT"],
							LEG_TALL_FINE_ROTATION_TABLE["UP_LEFT"],
							LEG_TALL_FINE_ROTATION_TABLE["RIGHT"],
							LEG_TALL_FINE_ROTATION_TABLE["UP_LEFT"],
							LEG_TALL_FINE_ROTATION_TABLE["RIGHT"],
							LEG_TALL_FINE_ROTATION_TABLE["UP_LEFT"],
							[TALL_TRI_FINE_RIGHT_RIGHT_LEFT_UP_LEFT,
	...
	TALL_TRI_FINE_RIGHT_RIGHT_LEFT_LEFT:
		Hex_Walker_Position(LEG_TALL_FINE_ROTATION_TABLE["RIGHT"],
							LEG_TALL_FINE_ROTATION_TABLE["LEFT"],
							LEG_TALL_FINE_ROTATION_TABLE["RIGHT"],
							LEG_TALL_FINE_ROTATION_TABLE["LEFT"],
							LEG_TALL_FINE_ROTATION_TABLE["RIGHT"],
							LEG_TALL_FINE_ROTATION_TABLE["LEFT"],
	...
	# 57
	TALL_TRI_FINE_RIGHT_UP_RIGHT_LEFT_LEFT:
		Hex_Walker_Position(LEG_TALL_FINE_ROTATION_TABLE["UP_RIGHT"],
							LEG_TALL_FINE_ROTATION_TABLE["LEFT"],
							LEG_TALL_FINE_ROTATION_TABLE["UP_RIGHT"],
							LEG_TALL_FINE_ROTATION_TABLE["LEFT"],
							LEG_TALL_FINE_ROTATION_TABLE["UP_RIGHT"],
							LEG_TALL_FINE_ROTATION_TABLE["LEFT"],
							[TALL_TRI_FINE_RIGHT_UP_RIGHT_LEFT_LEFT,
	...
	# 58
	TALL_TRI_FINE_RIGHT_UP_LEFT_LEFT_RIGHT:
		Hex_Walker_Position(LEG_TALL_FINE_ROTATION_TABLE["UP_LEFT"],
							LEG_TALL_FINE_ROTATION_TABLE["RIGHT"],
							LEG_TALL_FINE_ROTATION_TABLE["UP_LEFT"],
							LEG_TALL_FINE_ROTATION_TABLE["RIGHT"],
							LEG_TALL_FINE_ROTATION_TABLE["UP_LEFT"],
	...
	# 59
	TALL_TRI_FINE_RIGHT_LEFT_LEFT_RIGHT:
		Hex_Walker_Position(LEG_TALL_FINE_ROTATION_TABLE["LEFT"],
							LEG_TALL_FINE_ROTATION_TABLE["RIGHT"],
							LEG_TALL_FINE_ROTATION_TABLE["LEFT"],
							LEG_TALL_FINE_ROTATION_TABLE["RIGHT"],
							LEG_TALL_FINE_ROTATION_TABLE["LEFT"],
